...
means: current > (recommended * 0.90) && current < (recommended * 1.10). Basically, 
0the current portion should be between 90% and 110% of the recommended portion.
...
console.log(
  `Sarah's dog's Current food is : ${sarahsDog.curFood} is ${
    sarahsDog.curFood > sarahsDog.recommendedFood ? "bigger" : "lower"
