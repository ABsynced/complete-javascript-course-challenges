...
whether it's an adult ("Dog number 1 is an adult, and is 5 years old") or a puppy ("Dog number 2 is still a puppy 🐶")
...
const checkDogs = function (dogsJulia, dogsKate){
  ...
  dogsJuliaCorrected.splice(-1,1); // dogsJuliaCorrected.splice(-2):
